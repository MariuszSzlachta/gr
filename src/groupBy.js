function groupBy(myArray, key) {
  ...
  if (Array.isArray(myArray)){
    // v1: shows items in array that don't contain searched key. They are store under key of 'undefined'
    let tmp = myArray.filter(obj => obj.hasOwnProperty(key) ? key : null); // ver.1

    // v2: hides items in array that don't contain searched key. To use this version uncomment line below marked as ver.2 and comment line above marked as ver.1
